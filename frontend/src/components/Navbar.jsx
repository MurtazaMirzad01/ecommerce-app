    ...
    return (
        <div className='flex items-center justify-between py-5 font-medium'>
            ...
            <div className=' flex items-center gap-6'>
                <img src={assets.search_icon} className='w-5 cursor-pointer' alt="Search Icon" onClick={()=> setShowSearch(!showSearch)} />

                <div className='group relative'>
                    <img src={assets.profile_icon} className='w-5 cursor-pointer' alt="Search Icon" />
                ...
                <Link to={'/cart'} className='relative'>
                    ...
                    <p className='absolute right-[-4px] top-[10px] text-[10px] w-4 h-4 rounded-full bg-black text-white flex items-center justify-center'>{getCartCount()}</p>
                </Link>
